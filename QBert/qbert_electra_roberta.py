...
SCRIPT_VERSION = "v7-local-electra-checkpoints-2026-07-24"
...
MASTER_CSV = f"{BASE_DIR}/qbert_electra_roberta_results.csv"
...
ELECTRA_LOCAL_CHECKPOINT_DIR = "/media/shared/Devshree/edgellm3/glue_pruning/electra_finetuned_checkpoints"

CHECKPOINTS = {
    "ELECTRA-Base": {
        "sst2": f"{ELECTRA_LOCAL_CHECKPOINT_DIR}/sst2",
        "qnli": f"{ELECTRA_LOCAL_CHECKPOINT_DIR}/qnli",
        "qqp":  f"{ELECTRA_LOCAL_CHECKPOINT_DIR}/qqp",
        "mnli": f"{ELECTRA_LOCAL_CHECKPOINT_DIR}/mnli",
        "mrpc": f"{ELECTRA_LOCAL_CHECKPOINT_DIR}/mrpc",
        "rte":  "anirudh21/electra-base-discriminator-finetuned-rte",
        "stsb": f"{ELECTRA_LOCAL_CHECKPOINT_DIR}/stsb",
        "cola": "pszemraj/electra-base-discriminator-CoLA",
        "wnli": "anirudh21/electra-base-discriminator-finetuned-wnli",
    },
    "ROBERTA-Base": {
        "sst2": "textattack/roberta-base-SST-2",
        "qnli": "textattack/roberta-base-QNLI",
        "rte":  "textattack/roberta-base-RTE",
        "mrpc": "textattack/roberta-base-MRPC",
        "wnli": "textattack/roberta-base-WNLI",
        "mnli": "textattack/roberta-base-MNLI",
        "qqp":  "JeremiahZ/roberta-base-qqp",
        "stsb": "textattack/roberta-base-STS-B",
